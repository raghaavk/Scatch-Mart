          ...
          <div className="card">
            ...
            <div className="card__avatar">
              <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
                <circle cx={64} cy={64} fill="#60a5fa" r={60} />
                <circle cx={64} cy={64} fill="#85b4ec" opacity=".4" r={48} />
                <path
            ...
            <div className="card__title">{user.fullname}</div>
            <div className="card__subtitle">{user.contact}</div>
            <hr />
            <div className="flex">
              <svg
